...
import static org.apache.falcon.FalconClientUtil.validateFilterBy;
import static org.apache.falcon.FalconClientUtil.validateOrderBy;
...
public class FalconInstanceCommands extends BaseFalconCommands {
    ...
    public String running(
        ...
        return ResponseHelper.getString(BaseFalconCommands.getFalconClient().getRunningInstances(entityType.name(),
